...
def main():
    ...
    mdmt39_112_A_inst = (mdmt39_112_A_inst[3], mdmt39_112_A_inst[2], mdmt39_112_A, ALPHA)
    mdmt39_112_B_inst = (mdmt39_112_B_inst[3], mdmt39_112_B_inst[2], mdmt39_112_B, ALPHA)
    mdmt39_225_A_inst = (mdmt39_225_A_inst[3], mdmt39_225_A_inst[2], mdmt39_225_A, ALPHA)
    mdmt39_225_B_inst = (mdmt39_225_B_inst[3], mdmt39_225_B_inst[2], mdmt39_225_B, ALPHA)
    mdmt40_56_A_inst = (mdmt40_56_A_inst[3], mdmt40_56_A_inst[2], mdmt40_56_A, ALPHA)
    mdmt40_56_B_inst = (mdmt40_56_B_inst[3], mdmt40_56_B_inst[2], mdmt40_56_B, ALPHA)
    mdmt40_112_A_inst = (mdmt40_112_A_inst[3], mdmt40_112_A_inst[2], mdmt40_112_A, ALPHA)
    mdmt40_112_B_inst = (mdmt40_112_B_inst[3], mdmt40_112_B_inst[2], mdmt40_112_B, ALPHA)
    mdmt40_225_A_inst = (mdmt40_225_A_inst[3], mdmt40_225_A_inst[2], mdmt40_225_A, ALPHA)
    mdmt40_225_B_inst = (mdmt40_225_B_inst[3], mdmt40_225_B_inst[2], mdmt40_225_B, ALPHA)
  
    insts = [mdmt39_112_A_inst, mdmt39_112_B_inst, mdmt39_225_A_inst, mdmt39_225_B_inst, mdmt40_56_A_inst, mdmt40_56_B_inst, mdmt40_112_A_inst, mdmt40_112_B_inst, mdmt40_225_A_inst, mdmt40_225_B_inst]
    
    

    results = []
    for x in range(3):
        results.append(run_instances(insts))

    f=open("results/simulation.txt", 'w')
    f.write("Lines are execuions, columns have the values for each instance \n")
    for i in results:
        f.write("\n"+str(i))
    f.close
